import 'dart:math';
import 'package:ecobioweb/auth/models/constants.dart';
import 'package:ecobioweb/auth/providers/auth.dart';
...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    final logoHeight = min(
      ...
      Constants.kMaxLogoHeight,
    );
    final displayLogo = widget.logo != null && logoHeight >= Constants.kMinLogoHeight;
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget _buildDebugAnimationButtons() {
    ...
    return Positioned(
      ...
      right: 0,
      child: Row(
        key: Constants.kDebugToolbarKey,
        children: <Widget>[
          MaterialButton(
            color: Colors.green,
            onPressed: () {
