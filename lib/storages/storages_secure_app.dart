...
// void main() {
//   runApp(const MaterialApp(home: StoragesSecureApp()));
// }

class StoragesSecureApp extends StatefulWidget {
  const StoragesSecureApp({Key? key}) : super(key: key);

  @override
  StoragesSecureAppState createState() => StoragesSecureAppState();
}
...
class StoragesSecureAppState extends State<StoragesSecureApp> {
