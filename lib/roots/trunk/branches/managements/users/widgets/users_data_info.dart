...
import 'package:ecobioweb/roots/trunk/branches/managements/users/widgets/user_edit.dart';
...
class UsersDataInfo extends StatelessWidget {
  ...
  UsersDataInfo(this.textInputSearch, { Key? key}) : super(key: key);
      ...
      ChangeNotifierProvider<UsersProvider>(create: (_)=>UsersProvider()),
        ...
        child: Navigator(onGenerateRoute: (RouteSettings settings){
          ...
          return MaterialPageRoute(builder: (context){
            return UsersDataInfo(textInputSearch);
          });
        },
        ),
                    ...
                    // ),
                      ...
                      SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          // ),
                          rows: List.generate(usersDataFilter.length,(index) => usersDataRow(listFilesUsers[index],context),
...
DataRow usersDataRow(Users usersInfo, BuildContext context,) {
  // void Function(BuildContext)? onTap;


  Users userSelected=usersInfo;
  ...
  return DataRow(
    cells: [
      ...
      //   onTap: selectedRow(usersInfo,context),
    ...
    onLongPress:(){
      GestureDetector(
        ///   child: Text(listaEquipos[index][1]),
        onTap: (){
          Navigator.push(context, MaterialPageRoute(
              builder: (BuildContext context)
               => UsersAdd(user: userSelected,)
             /// => UsersEdit(users: userSelected,)
            // => DetallesEquipo(datosEquipo: listaEquipos[index][2])
          ));
    ...
    onSelectChanged: (usersInfo){
      ...
      //_onItemTapped(userSelected,context,onTap);

        ///addUser(userSelected,context,onTap);
...
onTap(BuildContext context) {
 ...
 /// addUser(userSelected,context,onTap);
  ...
  void _onItemTapped(Users userSelected, BuildContext context, void Function(BuildContext p1) onTap,) {


        onTap=    addUser(userSelected,context,onTap);
  }


 addUser(Users userSelected, BuildContext context, onTap) {
...
selectedRow(Users usersInfo, BuildContext context) {
