...
import 'package:flutter/material.dart';
import 'package:ecobioweb/roots/trunk/branches/managements/Roles/enum/enum.dart';
import 'package:ecobioweb/roots/trunk/branches/managements/Roles/utils/flutter_custom_select_item.dart';
import 'package:ecobioweb/roots/trunk/branches/managements/Roles/utils/utils.dart';
import 'package:ecobioweb/roots/trunk/branches/managements/Roles/widgets/flutter_custom_selector_sheet.dart';

import '../models/role.dart';


 class CustomMultiSelectField<T> extends StatefulWidget implements CustomBottomSheetSelector<T> {
  final double? width;
  final String title;
  ...
  final List<T> items;
  final List<Role>? itemsRole;
  final List<dynamic>? selectedItemsRole;
  final List<dynamic>? selectedMarketsEnabled;
...
class _CustomMultiSelectFieldState<T> extends State<CustomMultiSelectField<T>> {
  ...
  void initState() {
   ...
   // _customMultiSelectDropdownItem = _getDropdownItems(list: widget!.itemsRole);
    super.initState();
  }
