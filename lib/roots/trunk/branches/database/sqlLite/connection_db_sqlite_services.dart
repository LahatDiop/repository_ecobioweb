...
//
// class ConnectionDbSqlLiteServices {
//
//
//   static const int _version = 1;
//   static const String _dbName = "ecobio.db";
//
...
//   }
//
//   ///var execute=connectionDbSqlLiteParam();
//
...
//
//     join(await getDatabasesPath(), '../../assets/database/ecobio.db'),
//
...
//       return db.execute(
//         'CREATE IF NOT EXISTS TABLE dogs(id INTEGER PRIMARY KEY, name TEXT, age INTEGER)',
//       );
//     },
...
//   Dog.fromMapObject(Map<String, dynamic> refMap)
//       : id = refMap['id'],
//         name = refMap['name'],
//         age = refMap['age'];
//
