...
class AgricultureBiodynamicaProvider  with ChangeNotifier {
 ...
 Future<List<Product>> getData(int tabIndex) async{
  ...
  Future<List<Product>> getProductsList(int tabIndex) async {
    ...
    /// AgricultureBiodynamicaProvider().createState().setProductItemsList(productItemsList);
  ...
  void addItemProduct(Product product) {
   ...
   //AgricultureBiodynamicaProvider().productItems=productItems;
