...
class RepositoryApp{
  ...
  Future<List<Product>> fetchProductsFromRepository() async{
    try{
  ...
  void saveFavoritesToRepository(List<String> favorites) async{
    try{
      SharedPreferences pref =await SharedPreferences.getInstance();
      await pref.setStringList('favorites-products', favorites);
