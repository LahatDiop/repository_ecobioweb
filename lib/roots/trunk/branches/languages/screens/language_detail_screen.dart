...
class LanguageDetailScreen extends StatefulWidget {
  ...
  final Widget Function(BuildContext context, Language)? countryBuilder;
...
class _SelectionListState extends State<LanguageDetailScreen> {
  late List countries;
  ...
  void _sendDataBack(BuildContext context,PreferredSizeWidget? appBar, LanguageTheme? theme, Language initialSelection,List elements ) {
  ...
  Widget getListCountry(Language language) {
    return Container(
      height: 50,
      color: Colors.white,
      child: Material(
     ...
     //       String? defaultLocal = Localizations.localeOf(context); // => default en_US
         //   AppLocalizations appLocalizations = AppLocalizations(const Locale('it_IT'));
          ...
          //  String defaultSystemLocale=Platform.localeName;
            ...
            String? currentCodeLangApp = language.code;
            String? nameLanguageCodeChange = language.name;
        ...
        _sendDataBack(context,widget.appBar, widget.theme, language,elements);
  ...
  //    ///"it"
  //    String languageCodeDevice = deviceLocale.Language;
  //
  //   // String defaultSystemLocale=Platform.localeName;
  ...
  //    AppLocalizations.loadLanguageApp(Language,true);
  //
  //
  // }
}
