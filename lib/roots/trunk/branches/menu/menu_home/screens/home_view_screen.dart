...
import 'package:ecobioweb/roots/trunk/branches/menu/menu_search/screens/search_screen.dart';
...
import '../../navigation_bar/components/customerCategory.dart';
...
import '../../../../../../category/detailCategory/product_home.dart';
...
class HomeViewScreen extends StatefulWidget {
  ...
  _HomeViewScreenState createState() {
    return _HomeViewScreenState();
  }
}
...
// CATEGORY HOME "Agricultura Biologica", "Agricultura Biodinamica", "Agricultura Integrato", "KM Zero", "Prodotti Biologici"
  ...
  Widget build(BuildContext context) {
    ...
    //   ------------------------   INITE HEADER APICULTURE ----------------------------------

    final List<CustomerCategory> itemsBeekeepings = <CustomerCategory>[
    CustomerCategory(
    // description: 'agricultureBiologique',
    description: AppLocalizations.translate('honey').toString(),
    subtitle:  AppLocalizations.translate('honey').toString(),
    ...
    Widget headerListBioAgriculture =  ListView.builder(
    ...
    Widget headerListApicoltura = ListView.builder(
      itemBuilder: (context, index) {
      ...
      //  EdgeInsets padding= EdgeInsets.all(MediaQuery.of(context).size.width);
        ...
        return Padding(
          ...
          child: InkWell(
            onTap: () {
              if (itemsBeekeepings[index].description ==
                  AppLocalizations.translate('honey').toString()) {
                Navigator.of(context).push(MaterialPageRoute(
    ...
    Widget headerListBioEdilizia = ListView.builder(
      itemBuilder: (context, index) {
        EdgeInsets padding = index == 0
            ? const EdgeInsets.only(
    ...
    Widget headerListBioHotel = ListView.builder(
      itemBuilder: (context, index) {
        EdgeInsets padding = index == 0
            ? const EdgeInsets.only(
                left: 20.0, right: 10.0, top: 4.0, bottom: 4.0)
                            ...
                            Flexible(
                                ...
                                child:  Text(AppLocalizations.translate('agricolturaBio').toString().toUpperCase(),
                                   textAlign: TextAlign.left,
                                    style: const TextStyle(fontWeight: FontWeight.w500, fontFamily: "Roboto-Light.ttf", fontSize: 14,color: Colors.black87),
                                ))
                          ],),
                        ),
...
/* okk class _HomeViewScreenState
    extends State<HomeViewScreen> {
  @override
  Widget build(BuildContext context) {
    //return SafeArea();
