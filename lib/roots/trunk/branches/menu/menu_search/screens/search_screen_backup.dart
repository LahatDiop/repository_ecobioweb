...
class SearchScreenB extends StatefulWidget {
  ...
  SearchScreenB({Key? key,  this.item, this.itemCart, this.onAmountChanged,  AgricultureBiologicalProvider? agricultureBiologicalProvider}) : super(key: key);
...
class _SearchScreenState extends State<SearchScreenB> with TickerProviderStateMixin {
      ...
      // providers: [],
        ...
        builder: (context, child) {
         ...
         // var dataAgri=  context.read<AgricultureBiologicalProvider>().getData();
          ...
          ///   productFilter =productListFilter(_tabController.index, products);
