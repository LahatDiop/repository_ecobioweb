...
import '../singin/models/dart_helper.dart';
...
class _LoginCardUser extends StatefulWidget {
   const _LoginCardUser({
    ...
    required this.requireSignUpConfirmation, this.onSubmitCompleted, required this.hideForgotPasswordButton, required this.hideSignUpButton, required this.loginAfterSignUp, required this.hideProvidersTitle, this.introWidget,
  });
  ...
  @override
  _LoginCardUserState createState() => _LoginCardUserState();
}

class _LoginCardUserState extends State<_LoginCardUser> with TickerProviderStateMixin {
