...
import 'package:ecobioweb/roots/trunk/branches/menu/menu_settings/settings/auth/providers/auth.dart';
...
class __HeaderState extends State<_Header> {
  ...
  Widget build(BuildContext context) {
    ...
    final logoHeight = min(
      ...
      AppConstants.kMaxLogoHeight,
    );
    final displayLogo = widget.logo != null && logoHeight >= AppConstants.kMinLogoHeight;
...
class _FlutterLoginState extends State<FlutterLogin>
  ...
  Widget _buildDebugAnimationButtons() {
    ...
    return Positioned(
      ...
      right: 0,
      child: Row(
        key: AppConstants.kDebugToolbarKey,
        children: <Widget>[
          MaterialButton(
            color: Colors.green,
            onPressed: () {
