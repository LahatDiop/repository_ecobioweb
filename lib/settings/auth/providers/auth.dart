...
import 'package:ecobioweb/settings/auth/providers/flutter_login.dart';
...
/// The result is an error message, callback successes if message is null
typedef SignupCallback = Future<String?>? Function(UserData);
...
/// The result is an error message, callback successes if message is null
typedef BeforeAdditionalFieldsCallback = Future<String?>? Function(UserData);
