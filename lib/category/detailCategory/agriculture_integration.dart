...
class AgricultureIntegration extends StatefulWidget {
  const AgricultureIntegration({Key? key}) : super(key: key);

  @override
  _AgricultureIntegrationState createState() => _AgricultureIntegrationState();

 // static const routeName = '/agricultureIntegration';
}

class _AgricultureIntegrationState extends State<AgricultureIntegration> {
